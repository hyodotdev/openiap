...
### Documentation Commit Message Format Rules
...
### iOS Function Naming Conventions
...
- Swift Package Manager: `.package(url: "https://github.com/hyodotdev/openiap.git", from: "1.2.24")`
  - SPM automatically uses the Git tag, no separate deployment needed
