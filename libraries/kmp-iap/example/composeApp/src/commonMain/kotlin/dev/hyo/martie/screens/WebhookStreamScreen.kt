        ...
        Column(
            ...
            WebhookInfoCard(
                ...
                body = "The project-wide IAPKit stream contains lifecycle records and purchase identifiers. " +
                    "It requires an openiap-kit_sk_ secret admin key, which must never be embedded in a mobile app.",
                warning = true
            )
            WebhookInfoCard(
                title = "Mobile app",
...
private fun WebhookInfoCard(
    ...
    Card(
        ...
        colors = CardDefaults.cardColors(
            containerColor = if (warning) Color(0xFFFFF7ED) else Color.White
        ),
        ...
        Column(
            ...
            Text(body, color = AppColors.OnSurface)
        }
    }
}
