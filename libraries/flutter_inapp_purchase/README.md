...
<div align="center">
  ...
  A comprehensive Flutter plugin for implementing in-app purchases that conforms to the [OpenIAP Client Protocol](https://openiap.dev)
...
flutter_inapp_purchase conforms to the **[OpenIAP Client Protocol](https://openiap.dev)** — an open, vendor-neutral interoperability standard for in-app purchases. OpenIAP provides:
