...
- **Read-only order lookup** in the dashboard — paste an Apple or Google order ID from a customer receipt to see live order and subscription state with the project's existing store credentials; lookups are proxied live and never stored
