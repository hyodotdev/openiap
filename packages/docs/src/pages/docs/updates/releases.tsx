          ...
          <div style={{ marginBottom: '1.25rem' }}>
            ...
            >
              ...
              <li>
                ...
                <code>OpenIapError.DeveloperError</code> instead of
                overwriting the in-flight continuation, and a cancelled request
                can no longer clear a newer request's callback slot. Applied
          ...
          <div style={{ marginBottom: '1.25rem' }}>
            ...
            >
              <li>
                ...
                consumed by the native side. <code>chargeFullPrice</code>{' '}
                remains <code>5</code>. Full enum coverage added to{' '}
                <code>enums_unit_test.dart</code>.
              </li>
              <li>
                Picks up openiap-google 1.3.31 (callback race fix).
              </li>
            </ul>
          </div>
