...
enum ProviderIOS {
  /// Use StoreKit for payment processing (default for App Store distribution)
  Storekit('storekit'),
  /// Use OnsideKit for payment processing (for Onside distribution in Korea)
  Onside('onside');

  const ProviderIOS(this.value);
  final String value;

  factory ProviderIOS.fromJson(String value) {
    switch (value) {
      case 'storekit':
      case 'STOREKIT':
        return ProviderIOS.Storekit;
      case 'onside':
      case 'ONSIDE':
        return ProviderIOS.Onside;
    }
    throw ArgumentError('Unknown ProviderIOS value: $value');
  }
...
class InitConnectionConfig {
  ...
  factory InitConnectionConfig.fromJson(Map<String, dynamic> json) {
    return InitConnectionConfig(
      ...
      provider: json['provider'] != null ? ProviderConfig.fromJson(json['provider'] as Map<String, dynamic>) : null,
    );
  }
...
class ProviderConfig {
  ...
  /// 
  /// Defaults to 'storekit' if not specified.
  final ProviderIOS? ios;

  factory ProviderConfig.fromJson(Map<String, dynamic> json) {
    return ProviderConfig(
      ios: json['ios'] != null ? ProviderIOS.fromJson(json['ios'] as String) : null,
    );
  }
