...
public enum class ProviderIOS(val rawValue: String) {
    /**
    ...
    companion object {
        fun fromJson(json: Map<String, Any?>): InitConnectionConfig {
            return InitConnectionConfig(
                ...
                provider = (json["provider"] as Map<String, Any?>?)?.let { ProviderConfig.fromJson(it) },
            )
        }
    }
...
public data class ProviderConfig(
     ...
     */
    val ios: ProviderIOS? = null
) {
    companion object {
        fun fromJson(json: Map<String, Any?>): ProviderConfig {
            return ProviderConfig(
                ios = (json["ios"] as String?)?.let { ProviderIOS.fromJson(it) },
            )
        }
    }
