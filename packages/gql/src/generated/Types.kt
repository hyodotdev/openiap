...
public data class WebhookEvent(
    ...
    companion object {
        fun fromJson(json: Map<String, Any?>): WebhookEvent {
            return WebhookEvent(
                ...
                subscriptionState = (json["subscriptionState"] as? String)?.let { runCatching { SubscriptionState.fromJson(it) }.getOrNull() ?: SubscriptionState.Unknown },
...
public interface MutationResolver {
     ...
     * OpenIAP availability: Spec 2.4.0 / openiap-google 2.4.1.
