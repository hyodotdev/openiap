...
class OpenRedeemOfferCodeAmazonNoOpTest {
    ...
    fun `openRedeemOfferCode is a no-op returning false`() {
        ...
        assertFalse("Amazon openRedeemOfferCode must return false (no-op)", launched)
        assertNull(
            "Amazon openRedeemOfferCode must never launch an intent",
    ...
    fun `mutation bundle wires openRedeemOfferCodeAndroid for bundle parity`() {
        ...
        assertNotNull("Amazon flavor must wire openRedeemOfferCodeAndroid for bundle parity", handler)

        assertFalse(
            "Amazon openRedeemOfferCodeAndroid handler must return false (no-op)",
