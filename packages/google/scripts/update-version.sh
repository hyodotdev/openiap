...
echo "  - $REPO_ROOT/specs/client/package.json"
...
echo "  git add specs/client/package.json packages/docs/package.json packages/google/package.json packages/apple/package.json"
