...
describe("the published text makes no central claim", () => {
  ...
  // The monorepo sponsor block leaked in here once. Nothing regenerates it —
  // sync-sponsors only scans packages/ and libraries/ — and a spec that names
  // two of the four stores it specifies as its funders is not vendor-neutral.
