...
type Legacy @openiapDeprecated(reason: "Use Modern instead. Scheduled for removal in client protocol 3.0.0.") {
  old: String @deprecated(reason: "Use modern instead. Scheduled for removal in client protocol 3.0.0.")
}
...
`,
    ...
    expect(deprecations.typeReasons).toEqual(new Map([['Legacy', 'Use Modern instead. Scheduled for removal in client protocol 3.0.0.']]));
    expect(deprecations.operationArguments).toEqual([
      {
        rootName: 'Query',
        fieldName: 'value',
        argumentName: 'legacy',
        reason: 'Use current instead. Scheduled for removal in client protocol 3.0.0.',
      },
    ]);
    ...
    const deprecations = extractSchemaDeprecations([
      {
        ...
        sdl: `
type Legacy @deprecated(reason: "Wrong directive. Scheduled for removal in client protocol 3.0.0.") {
  old: String @openiapDeprecated(reason: "Wrong directive. Scheduled for removal in client protocol 3.0.0.")
}
...
`,
  ...
  it('rejects canonical reasons without the client protocol 3.0.0 removal schedule', () => {
    const deprecations = extractSchemaDeprecations([
      {
...
`,
    ...
    expect(deprecations.issues).toEqual([
      expect.objectContaining({
        ...
        message: expect.stringContaining('Scheduled for removal in client protocol <major>.<minor>.<patch>.'),
      }),
      expect.objectContaining({
        file: 'unscheduled.graphql',
        rule: 'deprecated-removal-schedule-missing',
    ...
    const deprecations = extractSchemaDeprecations([
      {
        ...
        sdl: `
type Query {
  old: String @deprecated(reason: "Use current instead. Scheduled for removal in client protocol 4.0.0.")
}
`,
      },
    ]);
    ...
    const deprecations = extractSchemaDeprecations([
      {
        ...
        sdl: `type Legacy @openiapDeprecated(reason: "Use Modern. Scheduled for removal in client protocol 3.0.0.") {
  value: String
}`,
      },
      {
        sourceId: 'extension.graphql',
        sdl: `extend type Legacy @openiapDeprecated(reason: "Duplicate. Scheduled for removal in client protocol 3.0.0.") {
  other: String
}`,
      },
    ]);
    ...
    const deprecations = extractSchemaDeprecations([
      {
        sourceId: 'base.graphql',
        sdl: `type Legacy {
  old: String @deprecated(reason: "Use current. Scheduled for removal in client protocol 3.0.0.")
}
type Query {
  value(legacy: String @deprecated(reason: "Use current. Scheduled for removal in client protocol 3.0.0.")): String
}`,
      },
      {
        sourceId: 'extension.graphql',
        sdl: `extend type Legacy {
  old: String @deprecated(reason: "Duplicate field. Scheduled for removal in client protocol 3.0.0.")
}
extend type Query {
  value(legacy: String @deprecated(reason: "Duplicate argument. Scheduled for removal in client protocol 3.0.0.")): String
}`,
      },
    ]);
    ...
    expect(deprecations.operationArguments).toEqual([
      {
        ...
        fieldName: 'value',
        argumentName: 'legacy',
        reason: 'Use current. Scheduled for removal in client protocol 3.0.0.',
      },
    ]);
  });
