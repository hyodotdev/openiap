...
export const completedRemovalRules = [
  {
    ...
    excluded: [
      "specs/client/src/deprecation-transformer.test.ts",
      "specs/client/src/schema-deprecations.test.mjs",
      "specs/client/src/generated-compatibility.test.ts",
      "specs/client/src/schema-linter.test.ts",
    ],
    tokens: [
      "validateReceipt",
      "validateReceiptIOS",
...
export const collectRepositorySchemaDeprecations = () => {
  const sources = SCHEMA_FILE_NAMES.map((sourceId) => ({
    sourceId,
    sdl: fs.readFileSync(path.join(root, "specs/client/src", sourceId), "utf8"),
  }));
