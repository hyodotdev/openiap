...
function checkFrameworkDependencyHygiene() {
  ...
  expectIncludes('libraries/maui-iap/src/OpenIap.Maui.Bindings.Android/OpenIap.Maui.Bindings.Android.csproj', [
    'Version="$(MauiPlayBillingVersion)"',
    'Version="$(MauiGsonVersion)"',
    'Version="$(MauiKotlinStdLibVersion)"',
    'Version="$(MauiKotlinCoroutinesVersion)"',
    'Version="$(MauiGoogleTransportApiVersion)"',
    'Version="$(MauiGoogleTransportBackendCctVersion)"',
    'Version="$(MauiGoogleTransportRuntimeVersion)"',
    'Version="$(MauiGooglePlayServicesBaseVersion)"',
    'Version="$(MauiGooglePlayServicesBasementVersion)"',
    'Version="$(MauiGooglePlayServicesLocationVersion)"',
    'Version="$(MauiGooglePlayServicesTasksVersion)"',
