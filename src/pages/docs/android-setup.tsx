function AndroidSetup() {
  return (
    <div className="doc-page">
      ...
      <p>
        Setting up in-app purchases for Android requires configuration in Google Play Console and your Android project.
      </p>
      ...
      <section>
        ...
        <h3 id="developer-account" className="anchor-heading">
          ...
          <a href="#developer-account" className="anchor-link">#</a>
        </h3>
        <ul>
          <li>Register for a Google Play Developer account ($25 one-time fee)</li>
        ...
        <h3 id="merchant-account" className="anchor-heading">
          ...
          <a href="#merchant-account" className="anchor-link">#</a>
        </h3>
        <ul>
          ...
          <li><strong>Important:</strong> Products won't work without a verified merchant account</li>
        </ul>
        ...
        <div style={{ 
          ...
          <strong>⚠️ Important:</strong> The merchant account must be fully verified before products become available. 
          This verification can take 24-48 hours after submitting your information.
        </div>
      </section>
      ...
      <section>
        <h2 id="play-console" className="anchor-heading">
          ...
          <a href="#play-console" className="anchor-link">#</a>
        </h2>
        
        <h3 id="create-app" className="anchor-heading">
          1. Create Your App
          <a href="#create-app" className="anchor-link">#</a>
        </h3>
        <ul>
          <li>Sign in to Google Play Console</li>
          <li>Click "Create app"</li>
          <li>Fill in app details (name, default language, app/game category)</li>
        ...
        <h3 id="upload-app" className="anchor-heading">
          2. Upload Your App
          <a href="#upload-app" className="anchor-link">#</a>
        </h3>
        ...
        <ul>
          ...
          <li>Choose your product type:
            <ul>
              <li><strong>Managed Products:</strong> One-time purchases or consumables</li>
              <li><strong>Subscriptions:</strong> Recurring subscriptions (requires separate setup)</li>
            </ul>
          </li>
        </ul>
        ...
        <ul>
          <li><strong>Product ID:</strong> Unique identifier (e.g., premium_upgrade, coins_100)</li>
          <li><strong>Name:</strong> Display name for users</li>
          <li><strong>Description:</strong> Product description</li>
          <li><strong>Price:</strong> Set price for each country/region</li>
          <li>Set product status to <strong>Active</strong></li>
        </ul>

        <h3 id="configure-subscriptions" className="anchor-heading">
          5. Configure Subscriptions (if applicable)
          <a href="#configure-subscriptions" className="anchor-link">#</a>
        </h3>
        <ul>
      ...
      <section>
        <h2 id="project-configuration" className="anchor-heading">
          ...
          <a href="#project-configuration" className="anchor-link">#</a>
        </h2>
        
        <h3 id="add-billing-permission" className="anchor-heading">
          1. Add Billing Permission
          <a href="#add-billing-permission" className="anchor-link">#</a>
        </h3>
...
<uses-permission android:name="android.permission.INTERNET" />`}</pre>
        ...
        <h3 id="update-build-gradle" className="anchor-heading">
          ...
          <a href="#update-build-gradle" className="anchor-link">#</a>
        </h3>
    ...
    // Your other dependencies
        ...
        <h3 id="configure-proguard" className="anchor-heading">
          ...
          <a href="#configure-proguard" className="anchor-link">#</a>
        </h3>
...
-keep class com.android.vending.billing.** { *; }`}</pre>
      ...
      <section>
        ...
        <h3 id="license-testing" className="anchor-heading">
          ...
          <a href="#license-testing" className="anchor-link">#</a>
        </h3>
        <ul>
        ...
        <h3 id="create-test-track" className="anchor-heading">
          2. Create Test Track
          <a href="#create-test-track" className="anchor-link">#</a>
        </h3>
        <ul>
        ...
        <h3 id="testing-best-practices" className="anchor-heading">
          ...
          <a href="#testing-best-practices" className="anchor-link">#</a>
        </h3>
        <ul>
          <li>Use the same Google account on the test device as added to license testing</li>
        ...
        <div style={{ 
          ...
          <strong>💡 Tip:</strong> For faster testing during development, use Android Debug Bridge (ADB) to clear 
          Google Play Store cache: <code>adb shell pm clear com.android.vending</code>
        </div>
      </section>
      ...
      <section>
        ...
        <p>
          To implement in-app purchases on Android, use one of the Open IAP specification libraries:
        </p>
        ...
        <p>
          These libraries implement the Open IAP specification and handle Android-specific requirements.
        </p>
      ...
      <section>
        <h2 id="android-requirements" className="anchor-heading">
          ...
          <a href="#android-requirements" className="anchor-link">#</a>
        </h2>
        
        <h3 id="purchase-acknowledgment" className="anchor-heading">
          Purchase Acknowledgment
          <a href="#purchase-acknowledgment" className="anchor-link">#</a>
        </h3>
        <p>Android requires acknowledging purchases within 3 days. Unacknowledged purchases are automatically refunded by Google Play.</p>
        
        <h3 id="consumable-products" className="anchor-heading">
          Consumable Products
          <a href="#consumable-products" className="anchor-link">#</a>
        </h3>
        <p>Consumable products must be consumed before they can be purchased again. This prevents duplicate purchases of items like coins or lives.</p>

        <h3 id="purchase-verification" className="anchor-heading">
          Purchase Verification
          <a href="#purchase-verification" className="anchor-link">#</a>
        </h3>
        <p>Always verify purchases server-side using the Google Play Developer API to prevent fraud and ensure purchase validity.</p>
        ...
        <div style={{ 
          ...
          <strong>⚠️ Important:</strong> Open IAP libraries handle these Android-specific requirements automatically. 
      ...
      <section>
        ...
        <h3 id="products-not-loading" className="anchor-heading">
          ...
          <a href="#products-not-loading" className="anchor-link">#</a>
        </h3>
        <p><strong>Problem:</strong> getProducts() returns empty array</p>
        ...
        <h4 id="verify-configuration" className="anchor-heading">
          ...
          <a href="#verify-configuration" className="anchor-link">#</a>
        </h4>
        <ul>
        ...
        <h3 id="purchase-flow-issues" className="anchor-heading">
          ...
          <a href="#purchase-flow-issues" className="anchor-link">#</a>
        </h3>
        <p><strong>Problem:</strong> "This item is not available" error</p>
        ...
        <h3 id="subscription-issues" className="anchor-heading">
          Subscription Issues
          <a href="#subscription-issues" className="anchor-link">#</a>
        </h3>
        <p><strong>Problem:</strong> Subscriptions not appearing</p>
        <p><strong>Solution:</strong></p>
        <ul>
      ...
      <section>
        <h2 id="production-checklist" className="anchor-heading">
          ...
          <a href="#production-checklist" className="anchor-link">#</a>
        </h2>
        <ul>
      ...
      <section>
        ...
        <ul>
          <li>Always validate purchases server-side using Google Play Developer API</li>
