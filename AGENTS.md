<!-- This file is the canonical agent guidelines. CLAUDE.md is a symlink to keep both names in sync. -->

# Project Guidelines for Claude

## Required Pre-Work

- Before writing or editing anything, load and review `CONVENTION.md` so the
  latest conventions are in context.
