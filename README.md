...
- **[kit](packages/kit)** - Hosted receipt-validation backend (SaaS + dashboard at [kit.openiap.dev](https://kit.openiap.dev)). Free for everyone; self-hostable. [![Kit CI](https://github.com/hyodotdev/openiap/actions/workflows/kit-deploy.yml/badge.svg?branch=main)](https://github.com/hyodotdev/openiap/actions/workflows/kit-deploy.yml?query=branch%3Amain)
