...
- `specs/openiap/client/src/` - GraphQL schema (API definitions)
...
**Google Play Billing (check specs/openiap/client/src/api-android.graphql):**
...
**StoreKit 2 (check specs/openiap/client/src/api-ios.graphql):**
